...
const PricingSection = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-natura-gold/10 to-natura-red/10 py-8 sm:py-12 border-y-2 border-natura-gold/20">
      <div className="container mx-auto max-w-4xl px-3 sm:px-4">
        <div className="text-center animate-fade-in">
          {/* Badge de Oferta */}
          <Badge className="mb-4 sm:mb-6 bg-natura-red text-white hover:bg-natura-red/90 text-sm sm:text-base font-bold px-4 sm:px-6 py-2 sm:py-3 inline-flex items-center animate-pulse-gold">
            <Zap className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
            OFERTA LIMITADA - 37% OFF
          </Badge>

          {/* Preços */}
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 lg:p-10 border-2 border-natura-gold/30 mx-2 sm:mx-0">
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 mb-6 sm:mb-8">
              {/* Preço Antigo */}
              <div className="text-center">
                <p className="text-gray-500 text-sm sm:text-base mb-1">De:</p>
                <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-400 line-through">
                  R$ 316,70
                </p>
              </div>

              {/* Seta/Divider */}
              <div className="hidden sm:block text-natura-gold text-2xl lg:text-3xl font-bold">→</div>
            ...
            {/* Economia */}
            <div className="bg-natura-gold/20 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 mx-2 sm:mx-0">
